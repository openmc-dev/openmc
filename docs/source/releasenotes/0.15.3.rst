...
- Added :meth:`openmc.Model.criticality_search` method for automated
  criticality searches (`#3569 <https://github.com/openmc-dev/openmc/pull/3569>`_)
...
- Several random ray solver enhancements:
  ...
  - Explicit void treatment (`#3299 <https://github.com/openmc-dev/openmc/pull/3299>`_ referenced in 0.15.1.rst)
