...
:attr:`Settings.pyne_source_mode` and :attr:`Settings.pyne_source_e_bounds` attributes should be
specified. For example, the following would sample the source from a PyNE
