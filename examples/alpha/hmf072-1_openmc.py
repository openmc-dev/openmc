...
cell40.region = -surf410 & -surf27 & +surf1080 & +surf110

# MAT4065
cell41 = openmc.Cell(cell_id=41, fill=mat4065)
cell41.region = -surf36 & -surf1080 & +surf113 & +surf110

# MAT517
cell42 = openmc.Cell(cell_id=42, fill=mat517)
cell42.region = -surf36 & -surf113 & +surf114 & +surf860

# MAT10
cell43 = openmc.Cell(cell_id=43, fill=mat10)
cell43.region = -surf113 & +surf114 & -surf860 & +surf110

# MAT4069
cell44 = openmc.Cell(cell_id=44, fill=mat4069)
cell44.region = -surf36 & -surf114 & +surf118 & +surf110

# MAT4073
cell45 = openmc.Cell(cell_id=45, fill=mat4073)
cell45.region = -surf36 & -surf118 & +surf122 & +surf110

# MAT519
cell46 = openmc.Cell(cell_id=46, fill=mat519)
cell46.region = -surf36 & -surf122 & +surf123 & +surf110

# MAT4077
cell47 = openmc.Cell(cell_id=47, fill=mat4077)
cell47.region = -surf36 & -surf123 & +surf127 & +surf110

# MAT4081
cell48 = openmc.Cell(cell_id=48, fill=mat4081)
cell48.region = -surf36 & -surf127 & +surf131 & +surf110

# MAT521
cell49 = openmc.Cell(cell_id=49, fill=mat521)
cell49.region = -surf36 & -surf131 & +surf132 & +surf110

# MAT4085
cell50 = openmc.Cell(cell_id=50, fill=mat4085)
cell50.region = -surf36 & -surf132 & +surf136 & +surf110

# MAT4089
cell51 = openmc.Cell(cell_id=51, fill=mat4089)
cell51.region = -surf36 & -surf136 & +surf140 & +surf110

# MAT523
cell52 = openmc.Cell(cell_id=52, fill=mat523)
cell52.region = -surf36 & -surf140 & +surf141 & +surf110

# MAT4093
cell53 = openmc.Cell(cell_id=53, fill=mat4093)
cell53.region = -surf36 & -surf141 & +surf145 & +surf110

# MAT4097
cell54 = openmc.Cell(cell_id=54, fill=mat4097)
cell54.region = -surf36 & -surf145 & +surf149 & +surf110

# MAT525
cell55 = openmc.Cell(cell_id=55, fill=mat525)
cell55.region = -surf36 & -surf149 & +surf150 & +surf110

# MAT4101
cell56 = openmc.Cell(cell_id=56, fill=mat4101)
cell56.region = -surf36 & -surf150 & +surf154 & +surf110

# MAT4105
cell57 = openmc.Cell(cell_id=57, fill=mat4105)
cell57.region = -surf36 & -surf154 & +surf158 & +surf110

# MAT527
cell58 = openmc.Cell(cell_id=58, fill=mat527)
cell58.region = -surf36 & -surf158 & +surf159 & +surf110

# MAT4109
cell59 = openmc.Cell(cell_id=59, fill=mat4109)
cell59.region = -surf36 & -surf159 & +surf163 & +surf110

# MAT4113
cell60 = openmc.Cell(cell_id=60, fill=mat4113)
cell60.region = -surf36 & -surf163 & +surf167 & +surf110

# MAT529
cell61 = openmc.Cell(cell_id=61, fill=mat529)
cell61.region = -surf36 & -surf167 & +surf168 & +surf110

# MAT4117
cell62 = openmc.Cell(cell_id=62, fill=mat4117)
cell62.region = -surf36 & -surf168 & +surf172 & +surf110

# MAT4121
cell63 = openmc.Cell(cell_id=63, fill=mat4121)
cell63.region = -surf36 & -surf172 & +surf176 & +surf110

# MAT531
cell64 = openmc.Cell(cell_id=64, fill=mat531)
cell64.region = -surf36 & -surf176 & +surf177 & +surf110

# MAT4125
cell65 = openmc.Cell(cell_id=65, fill=mat4125)
cell65.region = -surf36 & -surf177 & +surf181 & +surf110

# MAT20
cell66 = openmc.Cell(cell_id=66, fill=mat20)
cell66.region = -surf36 & -surf181 & +surf182 & +surf110

# MAT1
cell67 = openmc.Cell(cell_id=67, fill=mat1)
cell67.region = -surf36 & -surf182 & +surf183 & +surf185

# MAT1
cell68 = openmc.Cell(cell_id=68, fill=mat1)
cell68.region = -surf36 & -surf183 & +surf184 & +surf185

# MAT1
cell69 = openmc.Cell(cell_id=69, fill=mat1)
cell69.region = -surf186 & +surf187 & -surf27 & +surf188
...
source.space = openmc.stats.Box((-14.0, -12.26, 38.92), (14.0, 12.26, 81.75))
