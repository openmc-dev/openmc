...
# Box (6 planes): xmin=-17.5655, xmax=17.5655, ymin=-17.5655, ymax=17.5655, zmin=-30.0, zmax=144.15
surf4_xmin = openmc.XPlane(surface_id=10000, x0=-17.5655)
surf4_xmax = openmc.XPlane(surface_id=10001, x0=17.5655)
surf4_ymin = openmc.YPlane(surface_id=10002, y0=-17.5655)
surf4_ymax = openmc.YPlane(surface_id=10003, y0=17.5655)
...
# Box (6 planes): xmin=-47.5655, xmax=47.5655, ymin=-47.5655, ymax=47.5655, zmin=-30.0, zmax=144.15
surf5_xmin = openmc.XPlane(surface_id=10006, x0=-47.5655)
surf5_xmax = openmc.XPlane(surface_id=10007, x0=47.5655)
surf5_ymin = openmc.YPlane(surface_id=10008, y0=-47.5655)
surf5_ymax = openmc.YPlane(surface_id=10009, y0=47.5655)
