...
surf4 = openmc.model.RectangularParallelepiped(-17.2, 17.2, -17.2, 17.2, -30.0, 144.15)
# DX=DY=16*2.15 + 2*30 = 94.40 (refl planar bdy)
surf5 = openmc.model.RectangularParallelepiped(-47.2, 47.2, -47.2, 47.2, -30.0, 144.15, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-2.1, -2.1, 38.335), (2.1, 2.1, 40.335))
