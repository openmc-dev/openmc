"""
MIX-COMP-THERM-004-10: 21x21 MOX pins with 2.474 cm pitch; Hc=62.05
...
# Box (6 planes): xmin=-25.977, xmax=25.977, ymin=-25.977, ymax=25.977, zmin=-499.995, zmax=499.995
surf5_xmin = openmc.XPlane(surface_id=10000, x0=-25.977)
surf5_xmax = openmc.XPlane(surface_id=10001, x0=25.977)
surf5_ymin = openmc.YPlane(surface_id=10002, y0=-25.977)
surf5_ymax = openmc.YPlane(surface_id=10003, y0=25.977)
surf5_zmin = openmc.ZPlane(surface_id=10004, z0=-499.995)
surf5_zmax = openmc.ZPlane(surface_id=10005, z0=499.995)

# BCD
# Box (6 planes): xmin=-55.977, xmax=55.977, ymin=-55.977, ymax=55.977, zmin=-71.60000000000001, zmax=81.17
surf6_xmin = openmc.XPlane(surface_id=10006, x0=-55.977)
surf6_xmax = openmc.XPlane(surface_id=10007, x0=55.977)
surf6_ymin = openmc.YPlane(surface_id=10008, y0=-55.977)
surf6_ymax = openmc.YPlane(surface_id=10009, y0=55.977)
surf6_zmin = openmc.ZPlane(surface_id=10010, z0=-71.60000000000001)
surf6_zmax = openmc.ZPlane(surface_id=10011, z0=81.17)

# Middle grid, bottom
surf10 = openmc.ZPlane(surface_id=10, z0=80.57)

# Water height
surf11 = openmc.ZPlane(surface_id=11, z0=62.05)
...
u2_cell0.region = (+surf6_xmin & -surf6_xmax & +surf6_ymin & -surf6_ymax & +surf6_zmin & -surf6_zmax) & +surf10
u2_cell1 = openmc.Cell(fill=mat3, name="H2O")
u2_cell1.region = (+surf6_xmin & -surf6_xmax & +surf6_ymin & -surf6_ymax & +surf6_zmin & -surf6_zmax) & -surf11 & +surf12
u2_cell2 = openmc.Cell(fill=mat4, name="Al")
u2_cell2.region = (+surf6_xmin & -surf6_xmax & +surf6_ymin & -surf6_ymax & +surf6_zmin & -surf6_zmax) & -surf12 & +surf13
u2_cell3 = openmc.Cell(fill=mat3, name="H2O")
u2_cell3.region = (+surf6_xmin & -surf6_xmax & +surf6_ymin & -surf6_ymax & +surf6_zmin & -surf6_zmax) & -surf13 & +surf14
u2_cell4 = openmc.Cell(fill=mat4, name="Al")
u2_cell4.region = (+surf6_xmin & -surf6_xmax & +surf6_ymin & -surf6_ymax & +surf6_zmin & -surf6_zmax) & -surf14 & +surf15
u2_cell5 = openmc.Cell(fill=mat5, name="SS304L")
u2_cell5.region = (+surf6_xmin & -surf6_xmax & +surf6_ymin & -surf6_ymax & +surf6_zmin & -surf6_zmax) & -surf15 & +surf16
u2_cell6 = openmc.Cell(fill=mat3, name="H2O")
u2_cell6.region = (+surf6_xmin & -surf6_xmax & +surf6_ymin & -surf6_ymax & +surf6_zmin & -surf6_zmax) & -surf16 & +surf17
u2_cell7 = openmc.Cell(fill=mat5, name="SS304L")
u2_cell7.region = (+surf6_xmin & -surf6_xmax & +surf6_ymin & -surf6_ymax & +surf6_zmin & -surf6_zmax) & -surf17 & +surf18
u2_cell8 = openmc.Cell(fill=mat6, name="Conc")
u2_cell8.region = (+surf6_xmin & -surf6_xmax & +surf6_ymin & -surf6_ymax & +surf6_zmin & -surf6_zmax) & -surf18
...
# Unit 4: 21x21 lattice
# Lattice for unit 4: 21x21 array
# Pitch: (2.474000, 2.474000) cm
# Lower left: (-25.977, -25.977)

# Lattice filled with universe3
lattice4 = openmc.RectLattice(lattice_id=4)
lattice4.lower_left = [-25.977, -25.977]
lattice4.pitch = [2.474000, 2.474000]
lattice4.universes = [[universe3]*21]*21
...
cell0.region = (-surf5_xmin | +surf5_xmax | -surf5_ymin | +surf5_ymax | -surf5_zmin | +surf5_zmax) & (+surf6_xmin & -surf6_xmax & +surf6_ymin & -surf6_ymax & +surf6_zmin & -surf6_zmax)
...
cell2.region = +surf4 & (+surf6_xmin & -surf6_xmax & +surf6_ymin & -surf6_ymax & +surf6_zmin & -surf6_zmax)

# Cell using unit 4: lttc
cell3 = openmc.Cell(cell_id=3, fill=universe4, name="lttc")
cell3.region = (+surf5_xmin & -surf5_xmax & +surf5_ymin & -surf5_ymax & +surf5_zmin & -surf5_zmax) & (+surf6_xmin & -surf6_xmax & +surf6_ymin & -surf6_ymax & +surf6_zmin & -surf6_zmax)

# Cell: Conc
cell4 = openmc.Cell(cell_id=4, fill=mat6, name="Conc")
cell4.region = (+surf6_xmin & -surf6_xmax & +surf6_ymin & -surf6_ymax & +surf6_zmin & -surf6_zmax) & -surf18
...
source.space = openmc.stats.Point((0.0, 0.0, 31.025))
