...
mat1.add_nuclide("Pu241", 2.807700e-05)
mat1.add_nuclide("Pu242", 8.123400e-06)
mat1.add_nuclide("Am241", 1.205300e-06)
...
surf5 = openmc.model.RectangularParallelepiped(-25.977, 25.977, -25.977, 25.977, -499.995, 499.995)
# BCD
surf6 = openmc.model.RectangularParallelepiped(-55.977, 55.977, -55.977, 55.977, -71.60000000000001, 81.17, boundary_type="vacuum")
# Middle grid, bottom
