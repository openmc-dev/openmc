...
# Box (6 planes): xmin=-20.9875, xmax=20.9875, ymin=-20.9875, ymax=20.9875, zmin=-499.995, zmax=499.995
surf5_xmin = openmc.XPlane(surface_id=10000, x0=-20.9875)
surf5_xmax = openmc.XPlane(surface_id=10001, x0=20.9875)
surf5_ymin = openmc.YPlane(surface_id=10002, y0=-20.9875)
surf5_ymax = openmc.YPlane(surface_id=10003, y0=20.9875)
surf5_zmin = openmc.ZPlane(surface_id=10004, z0=-499.995)
surf5_zmax = openmc.ZPlane(surface_id=10005, z0=499.995)

# BCD
# Box (6 planes): xmin=-50.9875, xmax=50.9875, ymin=-50.9875, ymax=50.9875, zmin=-71.60000000000001, zmax=81.17
surf6_xmin = openmc.XPlane(surface_id=10006, x0=-50.9875)
surf6_xmax = openmc.XPlane(surface_id=10007, x0=50.9875)
surf6_ymin = openmc.YPlane(surface_id=10008, y0=-50.9875)
surf6_ymax = openmc.YPlane(surface_id=10009, y0=50.9875)
...
# Unit 4: 23x23 lattice
# Lattice for unit 4: 23x23 array
# Pitch: (1.825000, 1.825000) cm
# Lower left: (-20.9875, -20.9875)
...
lattice4.universes = [[universe3]*23]*23
