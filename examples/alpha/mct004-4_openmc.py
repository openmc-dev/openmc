"""
MIX-COMP-THERM-004-4: 21x21 MOX pins with 1.956 cm pitch; Hc=61.50
...
mat1.add_nuclide("Pu241", 2.8003e-5)
mat1.add_nuclide("Pu242", 8.1234e-6)
mat1.add_nuclide("Am241", 1.2793e-6)
...
# Box (6 planes): xmin=-20.538, xmax=20.538, ymin=-20.538, ymax=20.538, zmin=-499.995, zmax=499.995
surf5_xmin = openmc.XPlane(surface_id=10000, x0=-20.538)
surf5_xmax = openmc.XPlane(surface_id=10001, x0=20.538)
surf5_ymin = openmc.YPlane(surface_id=10002, y0=-20.538)
surf5_ymax = openmc.YPlane(surface_id=10003, y0=20.538)
surf5_zmin = openmc.ZPlane(surface_id=10004, z0=-499.995)
surf5_zmax = openmc.ZPlane(surface_id=10005, z0=499.995)

# BCD
# Box (6 planes): xmin=-50.538, xmax=50.538, ymin=-50.538, ymax=50.538, zmin=-71.60000000000001, zmax=81.17
surf6_xmin = openmc.XPlane(surface_id=10006, x0=-50.538)
surf6_xmax = openmc.XPlane(surface_id=10007, x0=50.538)
surf6_ymin = openmc.YPlane(surface_id=10008, y0=-50.538)
surf6_ymax = openmc.YPlane(surface_id=10009, y0=50.538)
...
# Water height
surf11 = openmc.ZPlane(surface_id=11, z0=61.50)
...
# Lower left: (-20.538, -20.538)

# Lattice filled with universe3
lattice4 = openmc.RectLattice(lattice_id=4)
lattice4.lower_left = [-20.538, -20.538]
lattice4.pitch = [1.956000, 1.956000]
...
source.space = openmc.stats.Point((0.0, 0.0, 30.75))
