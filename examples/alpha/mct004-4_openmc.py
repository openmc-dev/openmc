...
mat1.add_nuclide("Pu241", 2.800300e-05)
mat1.add_nuclide("Pu242", 8.123400e-06)
mat1.add_nuclide("Am241", 1.279300e-06)
...
surf5 = openmc.model.RectangularParallelepiped(-20.538, 20.538, -20.538, 20.538, -499.995, 499.995)
# BCD
surf6 = openmc.model.RectangularParallelepiped(-50.538, 50.538, -50.538, 50.538, -71.60000000000001, 81.17, boundary_type="vacuum")
# Middle grid, bottom
