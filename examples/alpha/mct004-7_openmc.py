...
# Box (6 planes): xmin=-22.25, xmax=22.25, ymin=-22.25, ymax=22.25, zmin=-499.995, zmax=499.995
surf5_xmin = openmc.XPlane(surface_id=10000, x0=-22.25)
surf5_xmax = openmc.XPlane(surface_id=10001, x0=22.25)
surf5_ymin = openmc.YPlane(surface_id=10002, y0=-22.25)
surf5_ymax = openmc.YPlane(surface_id=10003, y0=22.25)
surf5_zmin = openmc.ZPlane(surface_id=10004, z0=-499.995)
surf5_zmax = openmc.ZPlane(surface_id=10005, z0=499.995)

# BCD
# Box (6 planes): xmin=-52.25, xmax=52.25, ymin=-52.25, ymax=52.25, zmin=-71.60000000000001, zmax=81.17
surf6_xmin = openmc.XPlane(surface_id=10006, x0=-52.25)
surf6_xmax = openmc.XPlane(surface_id=10007, x0=52.25)
surf6_ymin = openmc.YPlane(surface_id=10008, y0=-52.25)
surf6_ymax = openmc.YPlane(surface_id=10009, y0=52.25)
