"""
HMF072-1: Zeus Iron Core Benchmark (6 Layers of Side Reflector 0.118" Al Shim)
...
# Top of Sixth Side Reflector Layer
surf8 = openmc.ZPlane(surface_id=8, z0=126.4412)
...
# Top of HEU Plate L8
surf113 = openmc.ZPlane(surface_id=113, z0=58.754433)

# Top of Iron Plate L8-4
surf114 = openmc.ZPlane(surface_id=114, z0=58.454713)

# Top of Iron Plate L7-8
surf118 = openmc.ZPlane(surface_id=118, z0=57.271073)

# Top of HEU Plate L7
surf122 = openmc.ZPlane(surface_id=122, z0=56.084470)

# Top of Iron Plate L7-4
surf123 = openmc.ZPlane(surface_id=123, z0=55.784750)

# Top of Iron Plate L6-8
surf127 = openmc.ZPlane(surface_id=127, z0=54.601110)

# Top of HEU Plate L6
surf131 = openmc.ZPlane(surface_id=131, z0=53.420433)

# Top of Iron Plate L6-4
surf132 = openmc.ZPlane(surface_id=132, z0=53.120713)

# Top of Iron Plate L5-8
surf136 = openmc.ZPlane(surface_id=136, z0=51.937497)

# Top of HEU Plate L5
surf140 = openmc.ZPlane(surface_id=140, z0=50.758090)

# Top of Iron Plate L5-4
surf141 = openmc.ZPlane(surface_id=141, z0=50.458370)

# Top of Iron Plate L4-8
surf145 = openmc.ZPlane(surface_id=145, z0=49.274730)

# Top of HEU Plate L4
surf149 = openmc.ZPlane(surface_id=149, z0=48.092783)

# Top of Iron Plate L4-4
surf150 = openmc.ZPlane(surface_id=150, z0=47.793063)

# Top of Iron Plate L3-8
surf154 = openmc.ZPlane(surface_id=154, z0=46.608153)

# Top of HEU Plate L3
surf158 = openmc.ZPlane(surface_id=158, z0=45.423243)

# Top of Iron Plate L3-4
surf159 = openmc.ZPlane(surface_id=159, z0=45.123523)

# Top of Iron Plate L2-8
surf163 = openmc.ZPlane(surface_id=163, z0=43.941577)

# Top of HEU Plate L2
surf167 = openmc.ZPlane(surface_id=167, z0=42.758360)

# Top of Iron Plate L2-4
surf168 = openmc.ZPlane(surface_id=168, z0=42.458640)

# Top of Iron Plate L1-8
surf172 = openmc.ZPlane(surface_id=172, z0=41.275423)

# Top of HEU Plate L1
surf176 = openmc.ZPlane(surface_id=176, z0=40.092207)

# Top of Iron Plate L1-4
surf177 = openmc.ZPlane(surface_id=177, z0=39.792487)

# Top of Lower Reflector
surf181 = openmc.ZPlane(surface_id=181, z0=38.599957)

# Top of Platen Adapter Plate
surf182 = openmc.ZPlane(surface_id=182, z0=24.172757)

# Top of Platen
surf183 = openmc.ZPlane(surface_id=183, z0=20.362757)

# Bottom of Platen
surf184 = openmc.ZPlane(surface_id=184, z0=17.822757)
...
# Bottom of Shim, Top of Iron Plate L8-8
surf1080 = openmc.ZPlane(surface_id=1080, z0=59.94908)


# Cell: VOID
cell0 = openmc.Cell(cell_id=0, fill=mat0, name="VOID")
...
# Cell: MAT11
cell10 = openmc.Cell(cell_id=10, fill=mat11, name="MAT11")
cell10.region = -surf410 & -surf27 & +surf1080 & +surf110

# Cell: MAT20
cell11 = openmc.Cell(cell_id=11, fill=mat20, name="MAT20")
cell11.region = +surf16 & -surf22 & +surf20 & -surf23 & +surf2 & -surf27 & +surf13

# Cell: MAT20
cell12 = openmc.Cell(cell_id=12, fill=mat20, name="MAT20")
cell12.region = +surf22 & -surf17 & +surf20 & -surf23 & +surf2 & -surf27 & +surf13

# Cell: MAT20
cell13 = openmc.Cell(cell_id=13, fill=mat20, name="MAT20")
cell13.region = +surf22 & -surf17 & +surf23 & -surf21 & +surf2 & -surf27 & +surf13

# Cell: MAT20
cell14 = openmc.Cell(cell_id=14, fill=mat20, name="MAT20")
cell14.region = +surf16 & -surf22 & +surf23 & -surf21 & +surf2 & -surf27 & +surf13

# Cell: MAT20
cell15 = openmc.Cell(cell_id=15, fill=mat20, name="MAT20")
cell15.region = +surf16 & -surf22 & +surf20 & -surf23 & +surf28 & -surf33 & +surf13

# Cell: MAT20
cell16 = openmc.Cell(cell_id=16, fill=mat20, name="MAT20")
cell16.region = +surf22 & -surf17 & +surf20 & -surf23 & +surf28 & -surf33 & +surf13

# Cell: MAT20
cell17 = openmc.Cell(cell_id=17, fill=mat20, name="MAT20")
cell17.region = +surf22 & -surf17 & +surf23 & -surf21 & +surf28 & -surf33 & +surf13

# Cell: MAT20
cell18 = openmc.Cell(cell_id=18, fill=mat20, name="MAT20")
cell18.region = +surf16 & -surf22 & +surf23 & -surf21 & +surf28 & -surf33 & +surf13

# Cell: MAT20
cell19 = openmc.Cell(cell_id=19, fill=mat20, name="MAT20")
cell19.region = +surf16 & -surf17 & +surf20 & -surf21 & +surf33 & -surf34

# Cell: MAT20
cell20 = openmc.Cell(cell_id=20, fill=mat20, name="MAT20")
cell20.region = -surf36 & -surf181 & +surf182 & +surf110

# Cell: MAT500
cell21 = openmc.Cell(cell_id=21, fill=mat500, name="MAT500")
cell21.region = -surf36 & +surf40 & -surf41

# Cell: MAT502
cell22 = openmc.Cell(cell_id=22, fill=mat502, name="MAT502")
cell22.region = -surf36 & +surf49 & -surf50

# Cell: MAT504
cell23 = openmc.Cell(cell_id=23, fill=mat504, name="MAT504")
cell23.region = -surf36 & +surf58 & -surf59

# Cell: MAT506
cell24 = openmc.Cell(cell_id=24, fill=mat506, name="MAT506")
cell24.region = -surf36 & +surf67 & -surf68

# Cell: MAT508
cell25 = openmc.Cell(cell_id=25, fill=mat508, name="MAT508")
cell25.region = -surf36 & +surf76 & -surf77

# Cell: MAT510
cell26 = openmc.Cell(cell_id=26, fill=mat510, name="MAT510")
cell26.region = -surf36 & +surf85 & -surf86

# Cell: MAT513
cell27 = openmc.Cell(cell_id=27, fill=mat513, name="MAT513")
cell27.region = -surf36 & +surf94 & -surf95

# Cell: MAT515
cell28 = openmc.Cell(cell_id=28, fill=mat515, name="MAT515")
cell28.region = -surf36 & +surf103 & -surf104 & +surf860

# Cell: MAT517
cell29 = openmc.Cell(cell_id=29, fill=mat517, name="MAT517")
cell29.region = -surf36 & -surf113 & +surf114 & +surf860

# Cell: MAT519
cell30 = openmc.Cell(cell_id=30, fill=mat519, name="MAT519")
cell30.region = -surf36 & -surf122 & +surf123 & +surf110

# Cell: MAT521
cell31 = openmc.Cell(cell_id=31, fill=mat521, name="MAT521")
cell31.region = -surf36 & -surf131 & +surf132 & +surf110

# Cell: MAT523
cell32 = openmc.Cell(cell_id=32, fill=mat523, name="MAT523")
cell32.region = -surf36 & -surf140 & +surf141 & +surf110

# Cell: MAT525
cell33 = openmc.Cell(cell_id=33, fill=mat525, name="MAT525")
cell33.region = -surf36 & -surf149 & +surf150 & +surf110

# Cell: MAT527
cell34 = openmc.Cell(cell_id=34, fill=mat527, name="MAT527")
cell34.region = -surf36 & -surf158 & +surf159 & +surf110

# Cell: MAT529
cell35 = openmc.Cell(cell_id=35, fill=mat529, name="MAT529")
cell35.region = -surf36 & -surf167 & +surf168 & +surf110

# Cell: MAT531
cell36 = openmc.Cell(cell_id=36, fill=mat531, name="MAT531")
cell36.region = -surf36 & -surf176 & +surf177 & +surf110

# Cell: MAT4001
cell37 = openmc.Cell(cell_id=37, fill=mat4001, name="MAT4001")
cell37.region = -surf36 & +surf28 & -surf40

# Cell: MAT4005
cell38 = openmc.Cell(cell_id=38, fill=mat4005, name="MAT4005")
cell38.region = -surf36 & +surf41 & -surf45

# Cell: MAT4009
cell39 = openmc.Cell(cell_id=39, fill=mat4009, name="MAT4009")
cell39.region = -surf36 & +surf45 & -surf49

# Cell: MAT4013
cell40 = openmc.Cell(cell_id=40, fill=mat4013, name="MAT4013")
cell40.region = -surf36 & +surf50 & -surf54

# Cell: MAT4017
cell41 = openmc.Cell(cell_id=41, fill=mat4017, name="MAT4017")
cell41.region = -surf36 & +surf54 & -surf58

# Cell: MAT4021
cell42 = openmc.Cell(cell_id=42, fill=mat4021, name="MAT4021")
cell42.region = -surf36 & +surf59 & -surf63

# Cell: MAT4025
cell43 = openmc.Cell(cell_id=43, fill=mat4025, name="MAT4025")
cell43.region = -surf36 & +surf63 & -surf67

# Cell: MAT4029
cell44 = openmc.Cell(cell_id=44, fill=mat4029, name="MAT4029")
cell44.region = -surf36 & +surf68 & -surf72

# Cell: MAT4033
cell45 = openmc.Cell(cell_id=45, fill=mat4033, name="MAT4033")
cell45.region = -surf36 & +surf72 & -surf76

# Cell: MAT4037
cell46 = openmc.Cell(cell_id=46, fill=mat4037, name="MAT4037")
cell46.region = -surf36 & +surf77 & -surf81

# Cell: MAT4041
cell47 = openmc.Cell(cell_id=47, fill=mat4041, name="MAT4041")
cell47.region = -surf36 & +surf81 & -surf85

# Cell: MAT4045
cell48 = openmc.Cell(cell_id=48, fill=mat4045, name="MAT4045")
cell48.region = -surf36 & +surf86 & -surf90

# Cell: MAT4049
cell49 = openmc.Cell(cell_id=49, fill=mat4049, name="MAT4049")
cell49.region = -surf36 & +surf90 & -surf94

# Cell: MAT4053
cell50 = openmc.Cell(cell_id=50, fill=mat4053, name="MAT4053")
cell50.region = -surf36 & +surf95 & -surf99

# Cell: MAT4057
cell51 = openmc.Cell(cell_id=51, fill=mat4057, name="MAT4057")
cell51.region = -surf36 & +surf99 & -surf103

# Cell: MAT4061
cell52 = openmc.Cell(cell_id=52, fill=mat4061, name="MAT4061")
cell52.region = -surf36 & +surf104 & -surf108

# Cell: MAT4065
cell53 = openmc.Cell(cell_id=53, fill=mat4065, name="MAT4065")
cell53.region = -surf36 & -surf1080 & +surf113 & +surf110

# Cell: MAT4069
cell54 = openmc.Cell(cell_id=54, fill=mat4069, name="MAT4069")
cell54.region = -surf36 & -surf114 & +surf118 & +surf110

# Cell: MAT4073
cell55 = openmc.Cell(cell_id=55, fill=mat4073, name="MAT4073")
cell55.region = -surf36 & -surf118 & +surf122 & +surf110

# Cell: MAT4077
cell56 = openmc.Cell(cell_id=56, fill=mat4077, name="MAT4077")
cell56.region = -surf36 & -surf123 & +surf127 & +surf110

# Cell: MAT4081
cell57 = openmc.Cell(cell_id=57, fill=mat4081, name="MAT4081")
cell57.region = -surf36 & -surf127 & +surf131 & +surf110

# Cell: MAT4085
cell58 = openmc.Cell(cell_id=58, fill=mat4085, name="MAT4085")
cell58.region = -surf36 & -surf132 & +surf136 & +surf110

# Cell: MAT4089
cell59 = openmc.Cell(cell_id=59, fill=mat4089, name="MAT4089")
cell59.region = -surf36 & -surf136 & +surf140 & +surf110

# Cell: MAT4093
cell60 = openmc.Cell(cell_id=60, fill=mat4093, name="MAT4093")
cell60.region = -surf36 & -surf141 & +surf145 & +surf110

# Cell: MAT4097
cell61 = openmc.Cell(cell_id=61, fill=mat4097, name="MAT4097")
cell61.region = -surf36 & -surf145 & +surf149 & +surf110

# Cell: MAT4101
cell62 = openmc.Cell(cell_id=62, fill=mat4101, name="MAT4101")
cell62.region = -surf36 & -surf150 & +surf154 & +surf110

# Cell: MAT4105
cell63 = openmc.Cell(cell_id=63, fill=mat4105, name="MAT4105")
cell63.region = -surf36 & -surf154 & +surf158 & +surf110

# Cell: MAT4109
cell64 = openmc.Cell(cell_id=64, fill=mat4109, name="MAT4109")
cell64.region = -surf36 & -surf159 & +surf163 & +surf110

# Cell: MAT4113
cell65 = openmc.Cell(cell_id=65, fill=mat4113, name="MAT4113")
cell65.region = -surf36 & -surf163 & +surf167 & +surf110

# Cell: MAT4117
cell66 = openmc.Cell(cell_id=66, fill=mat4117, name="MAT4117")
cell66.region = -surf36 & -surf168 & +surf172 & +surf110

# Cell: MAT4121
cell67 = openmc.Cell(cell_id=67, fill=mat4121, name="MAT4121")
cell67.region = -surf36 & -surf172 & +surf176 & +surf110
