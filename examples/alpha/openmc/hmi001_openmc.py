...
mat1.add_nuclide("Cr", 2.48397e-3)
mat1.add_nuclide("Ni", 1.09667e-3)
...
mat2.add_nuclide("Cr", 2.50498e-3)
mat2.add_nuclide("Ni", 1.11058e-3)
...
mat3.add_nuclide("Cr", 2.32285e-3)
mat3.add_nuclide("Ni", 1.08400e-3)
...
mat4.add_nuclide("Cr", 2.35918e-3)
mat4.add_nuclide("Ni", 1.10332e-3)

mat5 = openmc.Material(material_id=5, name="")
mat5.set_density("atom/b-cm", 7.606109e-02)
mat5.add_nuclide("Cr", 1.49836e-2)
mat5.add_nuclide("Ni", 6.61034e-3)
mat5.add_nuclide("Fe", 5.32325e-2)
mat5.add_nuclide("Al", 1.15377e-3)
mat5.add_nuclide("C0", 7.23704e-5)
mat5.add_nuclide("Mo", 8.51061e-6)

mat6 = openmc.Material(material_id=6, name="")
mat6.set_density("atom/b-cm", 7.666411e-02)
mat6.add_nuclide("Cr", 1.49334e-2)
mat6.add_nuclide("Ni", 6.45653e-3)
mat6.add_nuclide("Fe", 5.27897e-2)
mat6.add_nuclide("Al", 2.35245e-3)
mat6.add_nuclide("C0", 8.21637e-5)
mat6.add_nuclide("Mo", 4.98640e-5)
...
mat7.add_nuclide("Cr", 1.86022e-3)
mat7.add_nuclide("Ni", 8.08917e-4)
mat7.add_nuclide("Fe", 6.86642e-3)
mat7.add_nuclide("C0", 2.96046e-5)
...
root_universe = openmc.Universe(cells=[cell0, cell1, cell2, cell3, cell4, cell5, cell6, cell7])
