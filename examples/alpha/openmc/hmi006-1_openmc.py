...
surf15 = openmc.model.RectangularParallelepiped(
    -27.94, 27.94, -27.94, 27.94, 123.0376, 125.0376, surface_id=15)

# Copper/outer
surf16 = openmc.model.RectangularParallelepiped(
    -44.1452, 44.1452, -44.1452, 44.1452, 0.0, 123.9012, surface_id=16)
...
cell12.region = +surf14 & +surf15 & -surf16
...
root_universe = openmc.Universe(cells=[cell0, cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell9, cell10, cell11, cell12, cell13, cell14])
