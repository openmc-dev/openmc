...
mat21.add_nuclide("P", 7.8894)
mat21.add_nuclide("Fe", 70.194)
mat21.add_nuclide("Cr", 18.30)
mat21.add_nuclide("Ni", 8.21)
mat21.add_nuclide("Mn", 1.91)
mat21.add_nuclide("Si", 0.67)
mat21.add_nuclide("Cu", 0.31)

# Hoop #2 SST
mat22 = openmc.Material(material_id=22, name="Hoop #2 SST")
mat22.set_density("atom/b-cm", 1.074872e+02)
mat22.add_nuclide("P", 7.8932)
mat22.add_nuclide("Fe", 70.194)
mat22.add_nuclide("Cr", 18.30)
mat22.add_nuclide("Ni", 8.21)
mat22.add_nuclide("Mn", 1.91)
mat22.add_nuclide("Si", 0.67)
mat22.add_nuclide("Cu", 0.31)

# Tank Plates SST
mat23 = openmc.Material(material_id=23, name="Tank Plates SST")
mat23.set_density("atom/b-cm", 1.074770e+02)
mat23.add_nuclide("P", 7.8830)
mat23.add_nuclide("Fe", 70.194)
mat23.add_nuclide("Cr", 18.30)
mat23.add_nuclide("Ni", 8.21)
mat23.add_nuclide("Mn", 1.91)
mat23.add_nuclide("Si", 0.67)
mat23.add_nuclide("Cu", 0.31)

# Center Support SST
mat24 = openmc.Material(material_id=24, name="Center Support SST")
mat24.set_density("atom/b-cm", 1.074237e+02)
mat24.add_nuclide("P", 7.8297)
mat24.add_nuclide("Fe", 70.194)
mat24.add_nuclide("Cr", 18.30)
mat24.add_nuclide("Ni", 8.21)
mat24.add_nuclide("Mn", 1.91)
mat24.add_nuclide("Si", 0.67)
mat24.add_nuclide("Cu", 0.31)

# Al-6061 Supports
mat30 = openmc.Material(material_id=30, name="Al-6061 Supports")
mat30.set_density("atom/b-cm", 1.024150e+02)
mat30.add_nuclide("P", 2.69)
mat30.add_nuclide("Al", 97.325)
mat30.add_nuclide("Mg", 1.0)
mat30.add_nuclide("Si", 0.6)
mat30.add_nuclide("Fe", 0.35)
mat30.add_nuclide("Cu", 0.25)
mat30.add_nuclide("Cr", 0.2)
...
root_universe = openmc.Universe(cells=[cell0, cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell9, cell10, cell11, cell12, cell13, cell14, cell15, cell16, cell17, cell18, cell19, cell20, cell21, cell22, cell23, cell24])
