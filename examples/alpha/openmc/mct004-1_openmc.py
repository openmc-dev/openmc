...
surf5 = openmc.model.RectangularParallelepiped(
    -20.9875, 20.9875, -20.9875, 20.9875, -499.995, 499.995, surface_id=5)

# BCD
surf6 = openmc.model.RectangularParallelepiped(
    -50.9875, 50.9875, -50.9875, 50.9875, -71.60000000000001, 81.17, surface_id=6)
...
root_universe = openmc.Universe(cells=[cell0, cell1, cell2, cell3, cell4])
