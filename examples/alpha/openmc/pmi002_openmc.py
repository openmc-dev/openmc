...
mat2.add_nuclide("Cr", 1.57277e-2)
mat2.add_nuclide("Mn", 1.56081e-3)
mat2.add_nuclide("Co", 3.73582e-6)
mat2.add_nuclide("Ni", 6.94657e-3)

mat3 = openmc.Material(material_id=3, name="")
mat3.set_density("atom/b-cm", 2.383705e-02)
mat3.add_nuclide("Cr", 1.56286e-2)
mat3.add_nuclide("Mn", 1.42057e-3)
mat3.add_nuclide("Co", 3.77932e-6)
mat3.add_nuclide("Ni", 6.78410e-3)

mat4 = openmc.Material(material_id=4, name="")
mat4.set_density("atom/b-cm", 3.143137e-03)
mat4.add_nuclide("Cr", 1.82758e-3)
mat4.add_nuclide("Mn", 5.50350e-4)
mat4.add_nuclide("Co", 3.77222e-6)
mat4.add_nuclide("Ni", 7.61435e-4)

mat5 = openmc.Material(material_id=5, name="")
mat5.set_density("atom/b-cm", 1.791216e-03)
mat5.add_nuclide("Cr", 1.18727e-3)
mat5.add_nuclide("Mn", 1.05699e-4)
mat5.add_nuclide("Ni", 4.79539e-4)
mat5.add_nuclide("C0", 1.87078e-5)
...
root_universe = openmc.Universe(cells=[cell0, cell1, cell2, cell3, cell4, cell5])
