...
t_outer = np.arange(0.0, 1.5, 5.0e-1)
...
transient["Control Rod Base Bank 1"][0.0]["translation"] = [0.0, 0.0, 64.26]
transient["Control Rod Base Bank 1"][0.5]["translation"] = [0.0, 0.0, 21.42]
transient["Control Rod Base Bank 1"][1.0]["translation"] = [0.0, 0.0, 64.26]
