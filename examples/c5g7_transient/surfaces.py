...
surfaces["Fuel Inner Clad IR"] = openmc.ZCylinder(
    x0=0, y0=0, r=0.4180, name="Fuel Inner Clad IR"
)
surfaces["Fuel Inner Clad OR"] = openmc.ZCylinder(
    x0=0, y0=0, r=0.4750, name="Fuel Inner Clad OR"
)
surfaces["Fuel Outer Clad IR"] = openmc.ZCylinder(
    x0=0, y0=0, r=0.4800, name="Fuel Outer Clad IR"
)
surfaces["Fuel Outer Clad OR"] = openmc.ZCylinder(
    x0=0, y0=0, r=0.5400, name="Fuel Outer Clad OR"
)
...
surfaces["Lower Reflector z-min"] = openmc.ZPlane(
    z0=-85.68, name="Lower Reflector z-min"
)
surfaces["Upper Reflector z-max"] = openmc.ZPlane(
    z0=85.68, name="Upper Reflector z-max"
)
