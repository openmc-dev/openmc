...
int openmc_solidraytrace_plot_create(void** plot);
int openmc_solidraytrace_plot_free(void* plot);
int openmc_solidraytrace_plot_set_pixels(void* plot, int32_t width, int32_t height);
int openmc_solidraytrace_plot_set_color_by(void* plot, int32_t color_by);
int openmc_solidraytrace_plot_set_default_colors(void* plot);
int openmc_solidraytrace_plot_set_all_opaque(void* plot);
int openmc_solidraytrace_plot_set_visibility(void* plot, int32_t id, bool visible);
int openmc_solidraytrace_plot_set_color(void* plot, int32_t id, uint8_t r, uint8_t g, uint8_t b);
int openmc_solidraytrace_plot_set_camera_position(void* plot, double x, double y, double z);
int openmc_solidraytrace_plot_set_look_at(void* plot, double x, double y, double z);
int openmc_solidraytrace_plot_set_up(void* plot, double x, double y, double z);
int openmc_solidraytrace_plot_set_light_position(void* plot, double x, double y, double z);
int openmc_solidraytrace_plot_set_fov(void* plot, double fov);
int openmc_solidraytrace_plot_update_view(void* plot);
int openmc_solidraytrace_plot_create_image(void* plot, uint8_t* data_out, int32_t width, int32_t height);
int openmc_solidraytrace_plot_get_color(void* plot, int32_t id, uint8_t* r, uint8_t* g, uint8_t* b);
int openmc_solidraytrace_plot_set_diffuse_fraction(void* plot, double diffuse_fraction);
