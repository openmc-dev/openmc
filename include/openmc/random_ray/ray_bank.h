...
private:
  ...
  // Per-rank send buffers for ray data, including geometry state and angular
  // flux
  ...
  int reserved_buffer_size_ = 32; // Initial reserved size for send buffers, can
                                  // be tuned based on expected ray counts
