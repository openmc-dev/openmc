...
public:
  ...
  ParticleType particle_type() const override { return custom_source_->particle_type(); }
  SpatialDistribution* space() const override { return custom_source_->space(); }
  UnitSphereDistribution* angle() const override { return custom_source_->angle(); }
