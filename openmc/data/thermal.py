...
_THERMAL_NAMES = {
    ...
    'c_Li_in_7LiD': ('7li(7lid)',),
    'c_Li_in_7LiH': ('7li(7lih)',),
    'c_Mg24': ('mg', 'mg24', 'mg00', '24-mg'),
    'c_Mg_in_MgF2': ('mg in mgf2',),
    'c_Mg_in_MgO': ('mg in mgo',),
    'c_N_in_UN_100p': ('n-un-100p',),
    'c_N_in_UN_10p': ('n-un-10p',),
    'c_N_in_UN_5p': ('n-un-5p',),
    'c_N_in_UN': ('n-un', 'n(un)', 'n(un)    l', 'ninun'),
    'c_N_in_UN_HALEU': ('n-un-haleu',),
    'c_N_in_UN_HEU': ('n-un-heu',),
    'c_O_in_Al2O3': ('osap00', 'osap', 'o(al2o3)'),
    'c_O_in_BeO': ('obeo', 'o-beo', 'o-be', 'o/be', 'obeo00', 'o(beo)', 'o_beo'),
    'c_O_in_C5O2H8': ('o(lucite)',),
    'c_O_in_D2O': ('od2o', 'o-d2o', 'ohw00', 'o(d2o)'),
    'c_O_in_H2O_solid': ('oice', 'o-ice', 'o(ice-ih)'),
    'c_O_in_MgO': ('o in mgo',),
    'c_O_in_PuO2': ('o in puo2',),
    'c_O_in_SiO2_alpha': ('o_sio2a',),
    'c_O_in_UO2_100p': ('o-uo2-100p',),
    'c_O_in_UO2_10p': ('oinuo2-10p',),
    'c_O_in_UO2_5p': ('oinuo2-5p',),
    'c_O_in_UO2': ('ouo2', 'o-uo2', 'o2-u', 'o2/u', 'ouo200', 'o(uo2)'),
    'c_O_in_UO2_HALEU': ('ouo2-haleu',),
    'c_O_in_UO2_HEU': ('o_uo2-heu',),
    ...
    'c_Pu_in_PuO2': ('pu in puo2',),
    'c_Si28': ('si00', 'sili', 'si'),
    'c_Si_in_SiC': ('sisic', 'si-sic', 'si(3c-sic)', 'si_sic'),
    'c_SiO2_alpha': ('sio2', 'sio2a', 'sio2alpha', 'si_sio2a'),
    'c_SiO2_beta': ('sio2b', 'sio2beta'),
    'c_U_metal_100p': ('u-100p',),
    'c_U_metal_10p': ('u-10p',),
    'c_U_metal_5p': ('u-5p',),
    'c_U_metal': ('u-metal',),
    'c_U_metal_HALEU': ('u-haleu',),
    'c_U_metal_HEU': ('u-heu',),
    'c_U_in_UC_100p': ('uinuc_100p',),
    'c_U_in_UC_10p': ('uinuc_10p',),
    'c_U_in_UC_5p': ('uinuc_5p',),
    'c_U_in_UC': ('uinuc_nat',),
    'c_U_in_UC_HALEU': ('uinuc_haleu',),
    'c_U_in_UC_HEU': ('uinuc_heu',),
    'c_U_in_UN_100p': ('u-un-100p',),
    'c_U_in_UN_10p': ('u-un-10p',),
    'c_U_in_UN_5p': ('u-un-5p',),
    'c_U_in_UN': ('u-un', 'u(un)', 'u(un)    l', 'uinun'),
    'c_U_in_UN_HALEU': ('u-un-haleu',),
    'c_U_in_UN_HEU': ('u-un-heu',),
    'c_U_in_UO2_100p': ('uuo2-100p',),
    'c_U_in_UO2_10p': ('uuo2-10p',),
    'c_U_in_UO2_5p': ('uuo2-5p',),
    'c_U_in_UO2': ('uuo2', 'u-uo2', 'u-o2', 'u/o2', 'uuo200', 'u(uo2)'),
    'c_U_in_UO2_HALEU': ('uuo2-haleu',),
    'c_U_in_UO2_HEU': ('u_uo2-heu',),
