...
_THERMAL_NAMES = {
    ...
    'c_Bi': ('83-bi-',),
    'c_Bi_in_Ge3Bi4O12': ('bi(ge3bi4o',),
    'c_C6H6': ('benz', 'c6h6', 'benzine'),
    'c_C_in_Be2C': ('cbe2c', 'c(be2c)'),
    'c_C_in_C19H16_liquid': ('c(c19h16)l',),
    'c_C_in_C19H16_solid': ('c(c19h16)s',),
    'c_C_in_C2H6O_liquid': ('c(c2h6o)l',),
    'c_C_in_C2H6O_solid': ('c(c2h6o)s',),
    'c_C_in_C5O2H8': ('clucit', 'c(lucite)'),
    'c_C_in_C6H6_liquid': ('c(c6h6)l',),
    'c_C_in_C6H6_solid': ('c(c6h6)s',),
    'c_C_in_C7H8_liquid': ('c(c7h8)l',),
    'c_C_in_C7H8_solid': ('c(c7h8)s',),
    'c_C_in_C8H8': ('cc8h8', 'c(polystyr'),
    'c_C_in_C8H10_liquid': ('c(m-c8h10)l',),
    'c_C_in_C8H10_solid': ('c(m-c8h10)s',),
    'c_C_in_C9H12_liquid': ('c(c9h12)l',),
    'c_C_in_C9H12_solid': ('c(c9h12)s',),
    'c_C_in_CF2': ('ccf2', 'c(teflon)'),
    'c_C_in_CH2': ('c(c2h4)n r',),
    'c_C_in_CH4_liquid': ('c(ch4)l',),
    'c_C_in_CH4_solid': ('c(ch4)s',),
    'c_C_in_Diamond': ('c(c-diamon',),
    ...
    'c_Fe_in_Fe_alpha': ('fe(fe-alph',),
    'c_Fe_in_Fe_gamma': ('fe(fe-gamm',),
    'c_Ga_in_GaN': ('ga(gan)',),
    'c_Ga_in_GaSe': ('ga(gase)',),
    'c_Ge': ('ge',),
    'c_Ge_in_Ge3Bi4O12': ('ge(ge3bi4o',),
    'c_Ge_in_GeTe': ('ge(gete)',),
    ...
    'c_H_in_CaO2H2': ('h(caoh2)',),
    'c_H1_in_CaH2': ('h1cah2', 'h1_cah2'),
    'c_H2_in_CaH2': ('h2cah2', 'h2_cah2'),
    'c_H_in_C19H16_liquid': ('h(c19h16)l',),
    'c_H_in_C19H16_solid': ('h(c19h16)s',),
    'c_H_in_C2H6O_liquid': ('h(c2h6o)l',),
    'c_H_in_C2H6O_solid': ('h(c2h6o)s',),
    'c_H_in_C6H6_liquid': ('h(c6h6)l',),
    'c_H_in_C6H6_solid': ('h(c6h6)s',),
    'c_H_in_C7H8_liquid': ('h(c7h8)l',),
    'c_H_in_C7H8_solid': ('h(c7h8)s',),
    'c_H_in_C8H10_liquid': ('h(m-c8h10)l',),
    'c_H_in_C8H10_solid': ('h(m-c8h10)s',),
    'c_H_in_C9H12_liquid': ('h(c9h12)l',),
    'c_H_in_C9H12_solid': ('h(c9h12)s',),
    ...
    'c_H_in_MgH2': ('h(mgh2)',),
    'c_H_in_MgOH2': ('h(mgoh2)',),
    'c_H_in_NaMgH3': ('h(namgh3)',),
    'c_H_in_NaOH': ('h(naoh)',),
    ...
    'c_Mg_in_MgD2': ('mg(mgd2)',),
    'c_Mg_in_MgF2': ('mgmgf2', 'mg in mgf2'),
    'c_Mg_in_MgH2': ('mg(mgh2)',),
    'c_Mg_in_MgO': ('mgmgo', 'mg in mgo'),
    'c_Mg_in_MgOH2': ('mg(mgoh2)',),
    'c_Mg_in_NaMgH3': ('mg(namgh3)',),
    'c_Mo': ('mo',),
    'c_N_in_GaN': ('n(gan)',),
    ...
    'c_S_in_ZnS': ('s(zns-spha',),
    'c_Se_in_GaSe': ('se(gase)',),
    'c_Sn': ('sn',),
    'c_Sr_in_SrH2': ('sr(srh2)',),
    'c_Te_in_GeTe': ('te(gete)',),
    'c_Ti': ('ti',),
    ...
    'c_V': ('v',),
    'c_W': ('w',),
    'c_Y_in_Y3Al5O12': ('y(y3al5o12',),
    'c_Y_in_YH2': ('yyh2', 'y-yh2', 'y(yh2)'),
    'c_Zn': ('zn',),
    'c_Zn_in_ZnS': ('zn(zns-sph',),
    'c_Zr': ('zr',),
