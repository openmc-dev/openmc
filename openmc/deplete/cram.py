...
class Cram16Solver(IPFCramSolver):
    r"""Solver implementing the 16th order IPF CRAM

    Coefficients to :attr:`alpha`, :attr:`theta`, and :attr:`alpha0`
    are from Table A.IV in [Pusa16]_.
    ...
    def __call__(self, A, n0, dt):
        """Solve using 16th order IPF CRAM [Pusa16]_
        ...
        """
        return super().__call__(A, n0, dt)


class Cram48Solver(IPFCramSolver):
    r"""Solver implementing the 48th order IPF CRAM

    Coefficients to :attr:`alpha`, :attr:`theta`, and :attr:`alpha0`
    are from Table A.XII in [Pusa16]_.
    ...
    del theta_i, theta_r, alpha_r, alpha_i

    alpha0 = 2.258038182743983e-47

    def __call__(self, A, n0, dt):
        """Solve using 48th order IPF CRAM [Pusa16]_
