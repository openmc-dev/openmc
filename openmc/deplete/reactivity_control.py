...
class ReactivityController:
    """Controller for reactivity adjustment during depletion calculations.
    
    This class performs keff searches to maintain a target reactivity by adjusting
    ...
    """
    def __init__(self, operator, function: Callable, x0: float, x1: float, bracket: list[float], kwargs: Optional[dict] = None):
        if len(bracket) != 2:
        ...
        self.kwargs['x_min'] = bracket[0]
        self.kwargs['x_max'] = bracket[1]
