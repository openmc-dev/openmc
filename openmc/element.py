    ...
    def expand(
        ...
        if cross_sections is not None:
            ...
            # so, set the abundance to 1 for this nuclide.
                ...
                msg = (
                    f"Unable to expand element {self} because the cross "
            ...
            # common cross section libraries (ENDF, JEFF, and JENDL)
                ...
                for nuclide in absent_nuclides:
                    if nuclide in ["O17", "O18"] and "O16" in mutual_nuclides:
                        ...
                        msg = (
                            "Unsure how to partition natural abundance of "
        ...
        if enrichment is not None and enrichment_target is None:
            ...
            if self.name != "U":
                msg = (
                    "Enrichment procedure for Uranium was requested, "
            ...
            if enrichment_type == "ao":
                msg = (
                    "Enrichment procedure for Uranium requires that "
        ...
        # New treatment for arbitrary element
            ...
            if enrichment_target == "U235":
                msg = (
                    "There is a special procedure for enrichment of U235 "
            ...
            if len(abundances) != 2:
                msg = (
                    f"Element {self} does not consist of two naturally-occurring "
