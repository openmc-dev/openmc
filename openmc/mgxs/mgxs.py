...
class ChiDelayed(Chi):
    ...
    def __init__(self, domain=None, domain_type=None,
                 groups=None, by_nuclide=False, name='', delayed_groups=None):
        super(ChiDelayed, self).__init__(domain, domain_type, groups, by_nuclide, name)
    ...
    def delayed_groups(self, delayed_groups):
        cv.check_iterable_type('delayed groups', delayed_groups, int)
    ...
    def filters(self):
        ...
        if self.delayed_groups != None:
            delayed_group_filter = openmc.Filter('delayedgroup', self.delayed_groups)
            return [[delayed_group_filter, energyin], [delayed_group_filter, energyout]]
        else:
            return [[energyin], [energyout]]
    ...
    def get_slice(self, nuclides=[], groups=[]):
        ...
        if len(groups) != 0:
            ...
            tally_slice = delayed_nu_fission_out.get_slice(filters=['energyout'],
                                                           filter_bins=filter_bins)
        ...
        for subdomain in subdomains:
            ...
            for nuclide in nuclides:
                ...
                if self.delayed_groups != None:
                    ...
                    for delayed_group in range(1, self.num_delayed_groups+1):
