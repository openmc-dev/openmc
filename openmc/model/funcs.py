...
def rectangular_prism(width, height, axis='z', origin=(0., 0.),
                      ...
                      boundary_albedo=1.,
                      boundary_leakage=0., corner_radius=0.):
    ...
    boundary_albedo : float, optional
        Albedo of the prism's surfaces as a ratio of particle weight after interaction
