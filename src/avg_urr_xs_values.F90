...
!$omp threadprivate(tope)
    ...
    if (represent_params == E_RESONANCE) then
      ...
      case default
        call fatal_error('Resonance energy dependence of URR parameters not&
          & yet supported for LSSF = 1 isotopes')
      end select
...
10    format(A80)
      ...
      if (E_depend /= represent_params)&
        call fatal_error('E dependence disagreement')
      if (master)&
