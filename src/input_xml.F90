...
!===============================================================================
  ...
  subroutine read_settings_xml()
    ...
    if (check_for_node(doc, "resonance_scattering")) then
      ...
      ! Check if any resonant scatterers specified
      if (get_arraysize_string(node_res_scat, "scatterer") >= 1) then
        treat_res_scat = .true.
        n_res_scatterers_total = get_arraysize_string(node_res_scat, "scatterer")
        allocate(nuclides_0K(n_res_scatterers_total))
        call get_node_array(node_res_scat, "scatterer", nuclides_0K % nuclide)
        call get_node_array(node_res_scat, "method", nuclides_0K % scheme)
        call get_node_array(node_res_scat, "xs_label", nuclides_0K % name)
        call get_node_array(node_res_scat, "xs_label_0K", nuclides_0K % name_0K)
        call get_node_array(node_res_scat, "E_min", nuclides_0K % E_min)
        call get_node_array(node_res_scat, "E_max", nuclides_0K % E_max)
      end if
...
!===============================================================================
  ...
  subroutine read_materials_xml()
    ...
    integer :: k             ! loop index for resonant scatterers
