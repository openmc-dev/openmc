...
std::unordered_map<FilterType, std::string> filter_type_strings = {
  {FilterType::AZIMUTHAL, "azimuthal"}, {FilterType::CELLBORN, "cellborn"},
  {FilterType::CELLFROM, "cellfrom"}, {FilterType::CELL, "cell"},
  ...
  {FilterType::ENERGY, "energy"}, {FilterType::ENERGY_OUT, "energy_out"},
  {FilterType::LEGENDRE, "legendre"}, {FilterType::MATERIAL, "material"},
  {FilterType::MESH, "mesh"}, {FilterType::MESH_SURFACE, "meshsurface"},
  {FilterType::MU, "mu"}, {FilterType::PARTICLE, "particle"},
  {FilterType::POLAR, "polar"},
  {FilterType::SPHERICAL_HARMONICS, "sphericalharmonics"},
  {FilterType::SPATIAL_LEGENDRE, "spatiallegendre"},
  {FilterType::SURFACE, "surface"}, {FilterType::TIME, "time"},
  {FilterType::UNIVERSE, "universe"}, {FilterType::ZERNIKE, "zernike"},
