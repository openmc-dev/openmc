...
class SettingsFile(object):
  ...
  def setBatches(self, batches):
    ...
    if not is_integer(batches):
      msg = 'Unable to set batches to a non-integer value {0}'.format(batches)
      raise ValueError(msg)

    if batches <= 0:
      msg = 'Unable to set batches to a negative value {0}'.format(batches)
      raise ValueError(msg)
  ...
  def setParticles(self, particles):
    ...
    if particles <= 0:
      msg = 'Unable to set particles to a negative value {0}'.format(particles)
      raise ValueError(msg)
  ...
  def setSourceSpace(self, type, params):
    ...
    if not is_string(type):
      ...
      msg = 'Unable to set source space parameters to {0} since it does ' \
            'not contain 6 values'.format(params)
      raise ValueError(msg)
  ...
  def setSourceAngle(self, type, params=[]):
    ...
    if not is_string(type):
      ...
      msg = 'Unable to set source angle parameters to {0} since 3 ' \
            'parameters are required for monodirectional sources'.format(params)
      raise ValueError(msg)
  ...
  def setSourceEnergy(self, type, params=[]):
    ...
    if not is_string(type):
      ...
      msg = 'Unable to set source energy parameters to {0} since it is not ' \
            'a Python list/tuple or NumPy array'.format(params)
      raise ValueError(msg)

    elif type is 'monoenergetic' and not len(params) != 1:
      msg = 'Unable to set source energy parameters to {0} since 1 ' \
            'paramater is required for monenergetic sources'.format(params)
      raise ValueError(msg)

    elif type is 'watt' and len(params) != 2:
      msg = 'Unable to set source energy parameters to {0} since 2 ' \
            'parameters are required for monoenergetic sources'.format(params)
      raise ValueError(msg)
  ...
  def setOutput(self, output):
    ...
    if not isinstance(output, dict):
      msg = 'Unable to set output to {0} which is not a Python dictionary ' \
            'of string keys and boolean values'.format(output)
      raise ValueError(msg)
  ...
  def setVerbosity(self, verbosity):
    ...
    if not is_integer(verbosity):
      msg = 'Unable to set verbosity to non-integer value {0}'.format(verbosity)
      raise ValueError(msg)
  ...
  def setStatepointBatches(self, batches):
    ...
    if not isinstance(batches, (tuple, list, np.ndarray)):
      msg = 'Unable to set statepoint batches to {0} which is not a Python ' \
            'tuple/list or NumPy array'.format(batches)
      raise ValueError(msg)
    ...
    for batch in batches:
      ...
      if batch <= 0:
        msg = 'Unable to set statepoint batches with {0} which is less than ' \
              'or equal to zero'.format(batch)
        raise ValueError(msg)
  ...
  def setSourcepointBatches(self, batches):
    ...
    if not isinstance(batches, (tuple, list, np.ndarray)):
      msg = 'Unable to set sourcepoint batches to {0} which is not a Python ' \
            'tuple/list or NumPy array'.format(batches)
      raise ValueError(msg)
    ...
    for batch in batches:
      ...
      if batch <= 0:
        msg = 'Unable to set sourcepoint batches with {0} which is less than ' \
              'or equal to zero'.format(batch)
        raise ValueError(msg)
  ...
  def setPTables(self, ptables):
    ...
    if not isinstance(ptables, (bool, np.bool)):
      msg = 'Unable to set ptables to non-boolean value {0}'.format(ptables)
      raise ValueError(msg)
  ...
  def setRunCMFD(self, run_cmfd):
    ...
    if not isinstance(run_cmfd, (bool, np.bool)):
      msg = 'Unable to set run_cmfd to non-boolean value {0}'.format(run_cmfd)
      raise ValueError(msg)
  ...
  def setWeight(self, weight, weight_avg):
    ...
    if not is_float(weight):
      ...
      msg = 'Unable to set weight cutoff to negative value {0}'.format(weight)
      raise ValueError(msg)

    elif weight_avg < 0.0:
      msg = 'Unable to set weight avg. to negative value {0}'.format(weight_avg)
      raise ValueError(msg)
  ...
  def setEntropyLowerLeft(self, lower_left):
    ...
    if not isinstance(lower_left, (tuple, list)):
      msg = 'Unable to set entropy mesh lower left corner to {0} which is ' \
            'not a Python tuple or list'.format(lower_left)
      raise ValueError(msg)

    elif len(lower_left) < 3 or len(lower_left) > 3:
      msg = 'Unable to set entropy mesh lower left corner to {0} which is ' \
            'not a 3D point'.format(lower_left)
      raise ValueError(msg)
  ...
  def setEntropyUpperRight(self, upper_right):
    ...
    if not isinstance(upper_right, (tuple, list)):
      msg = 'Unable to set entropy mesh upper right corner to {0} which is ' \
            'not a Python tuple or list'.format(upper_right)
      raise ValueError(msg)

    elif len(upper_right) < 3 or len(upper_right) > 3:
      msg = 'Unable to set entropy mesh upper right corner to {0} which is ' \
            'not a 3D point'.format(upper_right)
      raise ValueError(msg)
  ...
  def setThreads(self, threads):
    ...
    if not is_integer(threads):
      ...
      msg = 'Unable to set the threads to a negative value {0}'.format(threads)
      raise ValueError(msg)
  ...
  def setTrace(self, trace):
    ...
    if not isinstance(trace, (list, tuple)):
      msg = 'Unable to set the trace to {0} which is not a Python tuple ' \
            'or list'.format(trace)
      raise ValueError(msg)
      ...
      msg = 'Unable to set the trace generation to {0} since it must be ' \
            'greater than or equal to 1'.format(trace[1])
      raise ValueError(msg)

    elif trace[2] < 1:
      msg = 'Unable to set the trace particle to {0} since it must be ' \
            'greater than or equal to 1'.format(trace[2])
      raise ValueError(msg)
  ...
  def setTrack(self, track):
    ...
    if not isinstance(track, (list, tuple)):
      msg = 'Unable to set the track to {0} which is not a Python tuple ' \
           'or list'.format(track)
      raise ValueError(msg)
      ...
      msg = 'Unable to set the track generation to {0} since it must be ' \
            'greater than or equal to 1'.format(track[1])
      raise ValueError(msg)

    elif track[2] < 1:
      msg = 'Unable to set the track particle to {0} since it must be ' \
           'greater than or equal to 1'.format(track[2])
      raise ValueError(msg)
  ...
  def setUFSDimension(self, dimension):
    ...
    if not is_integer(dimension) and not is_float(dimension):
      msg = 'Unable to set UFS dimension to non-integer or non-floating ' \
            'point value {0}'.format(dimension)
      raise ValueError(msg)

    elif dimension < 1:
      msg = 'Unable to set UFS dimension to value {0} which is less than ' \
            'one'.format(dimension)
      raise ValueError(msg)
  ...
  def setUFSLowerLeft(self, lower_left):
    ...
    if not isinstance(lower_left, (tuple, list, np.ndarray)):
      ...
      msg = 'Unable to set UFS mesh lower left corner to {0} which is not ' \
            'a 3D point'.format(lower_left)
      raise ValueError(msg)
  ...
  def setUFSUpperRight(self, upper_right):
    ...
    if not isinstance(upper_right, tuple) and not isinstance(upper_right, list):
      msg = 'Unable to set UFs mesh upper right corner to {0} which is ' \
            'not a Python tuple or list'.format(upper_right)
      raise ValueError(msg)

    if len(upper_right) < 3 or len(upper_right) > 3:
      msg = 'Unable to set UFS mesh upper right corner to {0} which is not ' \
            'a 3D point'.format(upper_right)
      raise ValueError(msg)
  ...
  def createBatchesSubelement(self):
    ...
    if not self._batches is None:
      ...
      if self._eigenvalue_element is None:
        self._eigenvalue_element = ET.SubElement(self._settings_file, "eigenvalue")
  ...
  def createGenerationsPerBatchSubelement(self):
    ...
    if not self._generations_per_batch is None:
      ...
      element = ET.SubElement(self._eigenvalue_element, "generations_per_batch")
  ...
  def createSourceSpaceSubelement(self):
    ...
    if not self._source_space_params is None:
      ...
      if self._source_subelement is None:
        self._source_subelement = ET.SubElement(self._settings_file, "source")
