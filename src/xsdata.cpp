...
XsData::XsData(bool fissionable, AngleDistributionType scatter_format, int n_pol,
...
XsData::scatter_from_hdf5(hid_t xsdata_grp, size_t n_ang,
     AngleDistributionType scatter_format, AngleDistributionType final_scatter_format,
     int order_data)
{
