...
def create_library():
    ...
    mat_1.set_chi(chi)
    mat_1.set_inverse_velocity(ispeed)
    ...
    mat_4.set_inverse_velocity(ispeed)
    ...
    mat_6.set_chi(chi)
    mat_6.set_inverse_velocity(ispeed)
...
def test_alpha_mg():
    ...
    mat_names = ['base leg', 'base tab', 'base hist', 'base matrix',
                 'base ang', 'micro']
    model = slab_mg(num_regions=6, mat_names=mat_names, alpha_mode_left=True)
