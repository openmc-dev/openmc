...
class HexLatticeOXTestHarness(PyAPITestHarness):
    def __init__(self, *args, **kwargs):
        ...
        fuel_ch_univ = openmc.Universe(
            universe_id=1, name="Fuel channel", cells=[infcell, clfcell, outfcell]
        )
        ...
        edge_length = (1.0 / np.sqrt(3.0)) * hexagonal_pitch
        ...
        hexprism = openmc.model.HexagonalPrism(
        ...
        lattice.center = (0.0, 0.0, length / 2.0)
        ...
        root_univ = openmc.Universe(
            universe_id=5, name="root universe", cells=[assembly_cell]
        )
