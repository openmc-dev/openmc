...
The surrounding cube has vacuum boundary conditions.
...
# Create cells
x_planes = [
    openmc.XPlane(x0=-5., boundary_type="vacuum"),
    openmc.XPlane(x0=0.),
    openmc.XPlane(x0=2.5),
    openmc.XPlane(x0=5.),
    openmc.XPlane(x0=10., boundary_type="vacuum")
]

y_planes = [
    openmc.YPlane(y0=-5., boundary_type="vacuum"),
    openmc.YPlane(y0=0.),
    openmc.YPlane(y0=2.5),
    openmc.YPlane(y0=5.),
    openmc.YPlane(y0=10., boundary_type="vacuum")
]

z_planes = [
    openmc.ZPlane(z0=-5., boundary_type="vacuum"),
    openmc.ZPlane(z0=0.),
    openmc.ZPlane(z0=2.5),
    openmc.ZPlane(z0=5.),
    openmc.ZPlane(z0=10., boundary_type="vacuum")
]
