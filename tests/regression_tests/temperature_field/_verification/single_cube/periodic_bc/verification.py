...
The cube has periodic boundary conditions.
...
# Create cells
x_planes = [
    openmc.XPlane(x0=0., boundary_type="periodic"),
    openmc.XPlane(x0=2.5),
    openmc.XPlane(x0=5., boundary_type="periodic")
]

y_planes = [
    openmc.YPlane(y0=0., boundary_type="periodic"),
    openmc.YPlane(y0=2.5),
    openmc.YPlane(y0=5., boundary_type="periodic")
]

z_planes = [
    openmc.ZPlane(z0=0., boundary_type="periodic"),
    openmc.ZPlane(z0=2.5),
    openmc.ZPlane(z0=5., boundary_type="periodic")
]

x_planes[0].periodic_surface = x_planes[2]
y_planes[0].periodic_surface = y_planes[2]
z_planes[0].periodic_surface = z_planes[2]
