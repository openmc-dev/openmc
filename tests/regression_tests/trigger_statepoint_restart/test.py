...
class TriggerStatepointRestartTestHarness(PyAPITestHarness):
    ...
    def _test_output_created(self):
        ...
        assert len(spfiles) == 2, "Two statepoint files should have been created"
        if not self._final_sp:
            ...
            # Second restart run
            assert spfiles[1] == self._final_sp, "Final statepoint names were different"
