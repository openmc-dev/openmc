...
def test_nb90_halflife(nb90):
    ...
    ufloat_close(nb90.decay_constant, log(2.0) / nb90.half_life)
...
def test_nb90_modes(nb90):
    ...
    ufloat_close(ec.energy, ufloat(6111000.0, 4000.0))
...
def test_fpy(u235_yields):
    ...
    assert u235_yields.energies == pytest.approx([0.0253, 500.0e3, 1.4e7])
...
def test_sources(ba137m, nb90):
    ...
    b = np.isclose(gamma_source.x, 661657.0)
