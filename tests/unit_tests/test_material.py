...
def test_get_material_photon_attenuation():
    ...
    energy_pb_1 = 1.58608E+04  # [eV]
    ref_mu_rho_pb_1 = 1.548E+02  # [cm^2/g]
    ...
    with pytest.raises(ValueError):
        mat_neg_rho.get_photon_mass_attenuation_coefficient(1.0e6)
