...
def test_get_activity():
    ...
    assert pytest.approx(m4.get_activity(units='Bq/kg')) == 355978108155.96594  # [Bq/kg]
...
def test_get_decay_heat():
    ...
    assert pytest.approx(m4.get_decay_heat(units='W/kg')) == 40.17515720273193 # [W/kg]
...
def test_decay_photon_energy():
    ...
    src_per_bgkg = m.get_decay_photon_energy(units='Bq/kg')
    assert src_per_bqg.integral() == src_per_bgkg.integral() * 1000
